...
{
    public class OrdersReadyForCompletionSpecification : BaseSpecification<Order>
    {
        public OrdersReadyForCompletionSpecification(OrderSpecParams orderParams)
        : base(o => 
            (o.Status == Core.Entities.OrderAggregate.OrderStatus.PaymentReceived) &&
